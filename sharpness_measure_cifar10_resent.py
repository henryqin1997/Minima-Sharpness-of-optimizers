...
if args.trainset:
    ...
    if not args.lb:
        json.dump([res, reseps, resori, original_loss, checkpoint['acc']],
                  open('trainset_sharpness_measure_{}_{}.json'.format(args.optimizer, args.max_lr), 'w+'))
    else:
        json.dump([res, reseps, resori, original_loss, checkpoint['acc']],
                  open('trainset_sharpness_measure_lb_{}_{}.json'.format(args.optimizer, args.max_lr), 'w+'))
